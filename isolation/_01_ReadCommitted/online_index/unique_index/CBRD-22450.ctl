...
C1: create table t1 (a int, b int);
C1: insert into t1 values (1,1), (2,2), (2,3);
C1: COMMIT;
...
C3: delete from t1 where b = 2;
MC: wait until C3 blocked;

C4: replace into t1 (select * from t1 where a > 0);
