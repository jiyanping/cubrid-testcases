/* 
Test Case: prepare & update
prepare statement to update duplicate data and commit while loading index with online;
...
C3: prepare st1 from 'update t1 set b=?,c=? where b=6';
C3: COMMIT;
